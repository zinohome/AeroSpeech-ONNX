...
#### 1. TTS模型文件
- **文件路径**: `models/tts/kokoro-multi-lang-v1_1/model.onnx`
- **下载地址**: https://huggingface.co/csukuangfj/kokoro-multi-lang-v1_1/resolve/main/model.onnx
- **说明**: Kokoro多语言TTS模型
- **用途**: 文本转语音核心模型
- **大小**: 约100-200MB

#### 2. TTS Tokens文件
- **文件路径**: `models/tts/kokoro-multi-lang-v1_1/tokens.txt`
- **下载地址**: https://huggingface.co/csukuangfj/kokoro-multi-lang-v1_1/resolve/main/tokens.txt
- **说明**: 词汇表文件
- **用途**: 模型解码必需
- **大小**: 约几KB到几MB
...
#### 3. TTS Voices文件
- **文件路径**: `models/tts/kokoro-multi-lang-v1_1/voices.bin`
- **下载地址**: https://huggingface.co/csukuangfj/kokoro-multi-lang-v1_1/resolve/main/voices.bin
- **说明**: 多说话人声音文件
- **用途**: 支持多说话人TTS（如果只需要单一声音可以省略）
- **大小**: 约几MB

#### 4. espeak-ng-data目录
- **文件路径**: `models/tts/kokoro-multi-lang-v1_1/espeak-ng-data/`
- **下载地址**: https://huggingface.co/csukuangfj/kokoro-multi-lang-v1_1/tree/main/espeak-ng-data
- **说明**: 文本处理数据目录
- **用途**: 用于文本到音素的转换（如果模型不需要可以省略）
- **大小**: 约几MB到几十MB

#### 5. dict目录
- **文件路径**: `models/tts/kokoro-multi-lang-v1_1/dict/`
- **下载地址**: https://huggingface.co/csukuangfj/kokoro-multi-lang-v1_1/tree/main/dict
- **说明**: 字典文件目录
...
### TTS最小配置
1. `models/tts/kokoro-multi-lang-v1_1/model.onnx`
2. `models/tts/kokoro-multi-lang-v1_1/tokens.txt`
...
# 下载TTS模型
curl -L -o models/tts/kokoro-multi-lang-v1_1/model.onnx \
  https://huggingface.co/csukuangfj/kokoro-multi-lang-v1_1/resolve/main/model.onnx

curl -L -o models/tts/kokoro-multi-lang-v1_1/tokens.txt \
...
# 检查TTS模型文件
ls -lh models/tts/kokoro-multi-lang-v1_1/
...
export TTS_MODEL_PATH=models/tts/kokoro-multi-lang-v1_1/model.onnx
export TTS_TOKENS_PATH=models/tts/kokoro-multi-lang-v1_1/tokens.txt
